            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border); transition: var(--transition); background: white;">
                    ...
                    <td style="padding: 20px;">
                        <div style="font-weight: 700; color: var(--text-main); font-size: 15px; margin-bottom: 4px;"><?php echo e($prod->name); ?></div>
                        <div style="font-size: 12px; color: var(--primary); font-weight: 600; background: rgba(37, 99, 235, 0.1); display: inline-block; padding: 2px 8px; border-radius: 6px;"><?php echo e(strtoupper($prod->category->name ?? 'UMUM')); ?></div>
                    </td>
                    <td style="padding: 20px;">
                    ...
                    <td style="padding: 20px; text-align: right; font-weight: 700; color: var(--text-main); font-size: 15px;">
                ...
                <tr>
                    <td colspan="6" style="text-align: center; padding: 60px 20px;">
                        ...
                        <h3 style="color: var(--text-main); font-size: 18px; margin-bottom: 8px;">Data Kosong</h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bonda-main\bonda-main\resources\views/products/index.blade.php ENDPATH**/ ?>