<?php $__env->startSection('title', 'Varap Japanese | Solusi Kasir Profesional'); ?>
...
<div style="min-height: 90vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 40px;">
    ...
    <h1 style="font-size: clamp(40px, 10vw, 90px); font-weight: 800; line-height: 1.1; margin-bottom: 24px; letter-spacing: -3px; color: #fff;">
        ...
        <span style="background: linear-gradient(to right, #E53935, #FFD700); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Sebagai Seni Transaksi.</span>
    </h1>
    ...
    <div style="margin-top: 100px; display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; width: 100%; max-width: 1000px;">
        ...
        <div class="card" style="text-align: left; padding: 30px;">
            ...
            <p style="font-size: 14px; color: var(--text-muted); line-height: 1.5;">Proses transaksi lebih cepat dengan antarmuka yang intuitif dan harmonis.</p>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ARAP_JAPAN\resources\views/welcome.blade.php ENDPATH**/ ?>