<?php $__env->startSection('title', 'Terminal Kasir | Varap Japanese'); ?>
...
<style>
    ...
    .cart-container {
        position: sticky;
        top: 110px; /* Adjusted for top navbar */
        padding: 0;
        overflow: hidden;
        display: flex;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ARAP_JAPAN\resources\views/cashier/index.blade.php ENDPATH**/ ?>