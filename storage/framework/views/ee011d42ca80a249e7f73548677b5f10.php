            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border); transition: var(--transition); background: white;">
                    ...
                    <td style="padding: 20px;">
                        <div style="font-weight: 700; color: var(--text-main); font-size: 15px; margin-bottom: 4px;"><?php echo e(\Carbon\Carbon::parse($trx->transaction_date)->format('d M Y')); ?></div>
                    ...
                    <td style="padding: 20px;">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            ...
                            <span style="font-size: 14px; font-weight: 600; color: var(--text-main);"><?php echo e($trx->user->name ?? 'Tidak Diketahui'); ?></span>
                        </div>
                    </td>
                    ...
                    <td style="padding: 20px; text-align: center;">
                        <a href="<?php echo e(route('transactions.print', $trx->id)); ?>" target="_blank"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\bonda-main\bonda-main\resources\views/transactions/index.blade.php ENDPATH**/ ?>