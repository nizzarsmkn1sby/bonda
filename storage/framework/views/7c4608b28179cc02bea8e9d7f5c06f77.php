<?php $__env->startSection('title', 'Dasbor | Varap Japanese'); ?>
...
<div class="grid grid-3" style="margin-bottom: 40px;">
    <div class="card" style="background: linear-gradient(135deg, #E53935 0%, #B71C1C 100%); color: white; border: none;">
        <div style="font-size: 14px; opacity: 0.9; margin-bottom: 8px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;">Pendapatan Hari Ini</div>
        <div style="font-size: 32px; font-weight: 800; text-shadow: 0 2px 10px rgba(0,0,0,0.3);">Rp <?php echo e(number_format($todaySales ?? 0, 0, ',', '.')); ?></div>
    </div>
...
<div class="grid grid-2">
    ...
    <div class="card" style="text-align: center; cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 250px;" onclick="window.location='<?php echo e(route('pos.index')); ?>'">
        <div style="font-size: 56px; margin-bottom: 20px; filter: drop-shadow(0 0 10px rgba(229,57,53,0.5));">🏮</div>
        <h3 style="color: #fff; margin-bottom: 12px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase;">TERMINAL KASIR</h3>
        <p style="color: var(--text-muted); font-size: 14px; max-width: 300px;">Buka antarmuka penjualan bergaya Sakura untuk memproses transaksi baru.</p>
    ...
    <div class="card" style="text-align: center; cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 250px;" onclick="window.location='<?php echo e(route('products.index')); ?>'">
        <div style="font-size: 56px; margin-bottom: 20px; filter: drop-shadow(0 0 10px rgba(255,215,0,0.3));">📦</div>
        <h3 style="color: #fff; margin-bottom: 12px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase;">KONTROL INVENTARIS</h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ARAP_JAPAN\resources\views/dashboard.blade.php ENDPATH**/ ?>