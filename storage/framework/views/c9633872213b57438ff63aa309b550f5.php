<?php $__env->startSection('title', 'Autentikasi | ARAP POS'); ?>
...
<div style="width: 100%; max-width: 450px; position: relative;">
    ...
    <div class="card" style="padding: 50px 40px; margin-bottom: 0;">
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <p style="color: var(--text-muted); font-size: 11px; text-transform: uppercase; letter-spacing: 1px; font-weight: 600;">
                Protokol: Keamanan Berlapis v2.4
            </p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ARAP\resources\views/auth/login.blade.php ENDPATH**/ ?>