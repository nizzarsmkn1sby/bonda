...
@section('title', 'Pendaftaran | Varap Japanese')
...
<div style="width: 100%; max-width: 500px; position: relative;">
    ...
    <div class="card" style="padding: 50px 40px; margin-bottom: 0;">
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                <label class="form-label" style="font-size: 12px; color: #fff;">Nama Lengkap</label>
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="operator@arap.sys" 
                       style="background: rgba(0,0,0,0.2); border-color: var(--border); border-radius: 12px; height: 50px; color: #fff;">
            </div>
            ...
            <div class="grid grid-2" style="gap: 15px; margin-bottom: 15px;">
                ...
                <div class="form-group">
                    <label class="form-label" style="font-size: 12px; color: #fff;">Konfirmasi Sandi</label>
                    <input type="password" name="password_confirmation" class="form-control" required placeholder="••••••••" 
                           style="background: rgba(0,0,0,0.2); border-color: var(--border); border-radius: 12px; height: 50px; color: #fff;">
                </div>
            </div>
            
            <button type="submit" class="btn btn-primary" style="width: 100%; height: 55px; font-size: 15px; letter-spacing: 1px; border-radius: 14px; margin-top: 10px;">
                Daftar Sekarang 🌸
            </button>
        </form>
    </div>
    ...
    <div style="text-align: center; margin-top: 30px;">
        <p style="color: var(--text-muted); font-size: 13px; font-weight: 500;">
            Sudah memiliki akun? <a href="{{ route('login') }}" style="color: #fff; font-weight: 700; text-decoration: none; border-bottom: 1px solid var(--primary); padding-bottom: 2px;">Masuk ke Sistem</a>
        </p>
    </div>
</div>
@endsection
