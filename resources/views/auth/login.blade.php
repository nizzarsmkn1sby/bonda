...
@section('title', 'Autentikasi | Varap Japanese')
...
<div style="width: 100%; max-width: 450px; position: relative;">
    ...
    <div class="card" style="padding: 50px 40px; margin-bottom: 0;">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="email" name="email" class="form-control" value="{{ old('email', 'owner@cashier.com') }}" required autofocus placeholder="operator@arap.sys" 
    ...
    <div style="text-align: center; margin-top: 30px;">
        <p style="color: var(--text-muted); font-size: 13px; font-weight: 500;">
            Belum memiliki akses? <a href="{{ route('register') }}" style="color: #fff; font-weight: 700; text-decoration: none; border-bottom: 1px solid var(--primary); padding-bottom: 2px;">Daftar Akun Baru</a>
        </p>
    </div>
</div>
@endsection
